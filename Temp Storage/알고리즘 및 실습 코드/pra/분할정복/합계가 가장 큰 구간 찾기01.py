...
def find_max_range(nums, l, h):
    ...
    mid_to_left_max_sum = mid_to_left_sum = 0
    mid_to_right_max_sum = mid_to_right_sum = 0
    ...
    for right_idx in range(mid + 1, h):
    ...
    right_max_sum = find_max_range(nums, mid + 1, h)

    return max(max(left_max_sum, right_max_sum), mid_to_left_max_sum + nums[mid] + mid_to_right_max_sum)
